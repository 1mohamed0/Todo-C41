...
import com.route.todoc41.databinding.ActivityTaskEditeBinding
...
import com.route.todoc41.ui.util.parcelable
import com.route.todoc41.ui.util.showDatePickerDialog
import com.route.todoc41.ui.util.showTimePickerDialog
import java.util.Calendar

class TaskEditeActivity : AppCompatActivity() {
    lateinit var binding: ActivityTaskEditeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTaskEditeBinding.inflate(layoutInflater)
        ...
        onSelectTimeClick()
        setupToolbar()
        val task = intent.parcelable<Task>(Constant.TASK_KEY) as Task
    ...
    override fun onStart() {
        super.onStart()
        dao = MyDatabase.init(this).tasksDao()
    }
